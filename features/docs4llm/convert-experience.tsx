...
import { PipelineProgress } from "@/components/docs4llm/pipeline-progress";
import {
  ResultDashboard,
  StatusBadge,
} from "@/components/docs4llm/result-dashboard";
import { RetryConversionButton } from "@/components/docs4llm/retry-conversion-button";
import { TerminalLog } from "@/components/docs4llm/terminal-log";
      ...
      <div className="flex min-h-dvh">
        ...
        <aside className="sticky top-0 hidden h-dvh w-64 shrink-0 flex-col border-border/60 border-r bg-muted/20 px-4 py-5 md:flex">
          <Link className="flex items-center gap-2 px-2" href="/">
            ...
            <span className="font-display font-semibold text-sm">docs4llm</span>
          </Link>
