...
const INTENT_PATTERNS: RegExp[] = [
  ...
  /\b(?:mcp|docs4llm|tools?|toolkit|workflows?|agent|cursor)\b/i,
  /\bfrom\s+https?:\/\//i,
...
/**
 * Decide whether a user message is asking docs4llm to convert a docs URL
 ...
 */
export function detectDocs4LlmIntent(text: string): Docs4LlmIntent {
