...
import { InstallButtons } from "@/components/docs4llm/install-buttons";
...
function InsightsSection({
  ...
  return (
    <section className="scroll-mt-8" id="insights">
      <SectionIntro
        description="What docs4llm inferred while building your server."
        ...
        <Framed className="grid grid-cols-1 lg:grid-cols-2">
          ...
          {token ? (
            <div className={cn(CELL, "space-y-3")}>
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                Paste the config into Cursor → Settings → MCP. docs4llm serves
                {` ${pageCount} `}
