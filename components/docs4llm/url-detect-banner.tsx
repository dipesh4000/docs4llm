...
type UrlDetectBannerProps = {
  url: string;
  /** Whether the docs4llm toggle is currently on. */
  modeEnabled: boolean;
  loading: boolean;
  onGenerate: () => void;
  onDismiss: () => void;
 ...
 * the MCP is only built when docs4llm mode is on — otherwise the message is a
      ...
      <div className="flex items-start gap-3 px-3.5 py-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-[11px] text-muted-foreground leading-relaxed">
            {modeEnabled
              ? "docs4llm is on — generate a hosted MCP server from this page, or press Enter to ask about it."
              : "Turn on docs4llm to convert this into an MCP server. Otherwise, press Enter to just ask about this page."}
          </p>
