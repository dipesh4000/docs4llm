...
export const metadata: Metadata = {
  title: "Terms & Conditions — docs4llm",
  description:
    "The terms that govern your use of docs4llm — accounts, plans, acceptable use, IP, liability, and governing law.",
};
...
export default function TermsAndConditionsPage() {
  return (
    <main className="landing-page relative min-h-screen overflow-x-hidden">
      ...
      <LegalPage
        intro="By creating a docs4llm account or using our website, app, or APIs, you agree to these Terms & Conditions. Please read them carefully — they form a legally binding agreement between you and us."
        ...
        sections={[
          {
            ...
            body: (
              <p>
                docs4llm lets you convert public documentation URLs into Model
            ...
            body: (
              <>
                ...
                <ul className="list-disc space-y-1 pl-5">
                  ...
                  <li>
                    Use docs4llm to crawl or attack any site you do not own or
          ...
          },
          {
            ...
            body: (
              <p>
                The docs4llm software, brand, and original content are owned by
          ...
          },
          {
            ...
            body: (
              <p>
                ...
                it. docs4llm is not a substitute for professional advice.
              </p>
            ),
          },
          {
            ...
            body: (
              <p>
                ...
                service. Scheduled maintenance, upstream provider outages
                    (Vercel, Supabase, OpenRouter), or events beyond
          ...
          },
          {
            ...
            body: (
              <p>
                You can stop using docs4llm at any time and delete your account
